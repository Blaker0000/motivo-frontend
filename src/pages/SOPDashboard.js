...
export default function SOPDashboard() {
  ...
  const fetchSOPs = async () => {
    try {
      const res = await fetch("https://motivo-backend.onrender.com/api/sops");
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await fetch("https://motivo-backend.onrender.com/api/sops/upload_pdf", {
        method: "POST",
        body: formData,
      });
      const data = await res.json();
  ...
  const handleSummarize = async (sopId) => {
    try {
      const res = await fetch(`https://motivo-backend.onrender.com/api/sops/summarize_pdf/${sopId}`, {
        method: "POST",
      });
      const data = await res.json();
  ...
  const handlePushToSmartSheet = async (sopId) => {
    try {
      const res = await fetch(`https://motivo-backend.onrender.com/api/sops/insert_to_smartsheet/${sopId}`, {
        method: "POST",
      });
      const data = await res.json();
  ...
  const handleCommand = async () => {
    try {
      const res = await fetch("https://motivo-backend.onrender.com/api/sops/chat_command", {
        method: "POST",
